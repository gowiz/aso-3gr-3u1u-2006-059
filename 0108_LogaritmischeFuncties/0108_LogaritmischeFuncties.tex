...
\begin{itemize}
  ...
  \end{align*}
  \item Soms kunnen we logarimen berekenen die anders moeilijk rechtstreeks in het gegeven grondtal te berekenen zijn, bijvoorbeeld:
  \begin{align*}
...
\begin{itemize}
  ...
  \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
    ...
    \draw[color=gray] (0.5,4) node[anchor=north west] {$y=2^x$};
