...
\[\omega = \psi ( \cos \varphi + i \sin \varphi ) \]
We vinden dus $\omega$ als we de waarden voor $\psi\in\mathbb{R}$ en $\varphi\in[0\degree,360\degree[$ vinden.

Omdat $\omega$ een $n$-de machtswortel van $z$ is geldt er
\begin{align*}
       & \quad \omega^n = z\\
  \Leftrightarrow \qquad & \begin{cases} \psi^n = r\\ n\varphi = \phi + k \cdot 360\degree \qquad k\in\mathbb{Z} \end{cases}
\end{align*}
...
\begin{mdframed}
  \begin{align*}
    \psi &= \sqrt[n]{r}\\
    \varphi &= \dfrac{\phi + k \cdot 360\degree}{n} \qquad k\in\mathbb{Z}
  \end{align*}
\end{mdframed}
