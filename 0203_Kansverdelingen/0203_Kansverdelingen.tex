...
\begin{mdframed}
Voor elke $x$ geldt $f(\mu-x)=f(\mu+x)$. $f$ is dus {\em symmetrisch} ten opzichte van $x=\mu$. In $\mu$ bereikt $f$ haar {\em maximum}. De waarde van $\mu$ bepaalt dus de centrale ligging en de waarde van $\sigma$ bepaalt de spreiding.
\end{mdframed}
