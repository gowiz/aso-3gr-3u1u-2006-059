...
{\em \small Hint:\\
Definieer eerst twee gebeurtenissen, $J_{rood}$ en $K_{groen}$. Je wenst dus de kans $P(J_{rood}\cap K_{groen})$ te berekenen. Kijk eerst of de twee gebeurtenissen $J_{rood}$ en $K_{groen}$  afhankelijk of onafhankelijk zijn. Gebruik nu de juiste formule.
}
\end{oefening}
