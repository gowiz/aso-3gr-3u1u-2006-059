...
\begin{oefening}
  ...
  \begin{center}
    \definecolor{cqcqcq}{rgb}{0.75,0.75,0.75}
    \begin{tikzpicture}[scale=0.95, line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
...
\begin{center}
\begin{tabu} spread 2em{X[$c$]|X[$c$]X[$c$]X[$c$]X[$c$]X[$c$]}
...
\begin{center}
\begin{tabu} spread 1.5em{X[$c$]|*7{X[$c$]}}
    x&-\infty& &-\dfrac{2}{3}& &\dfrac{3}{2} &  &+\infty\\[.2em]
    \hline
    y&       &-&     0       &+&       0     & -
  \end{tabu}
\end{center}
