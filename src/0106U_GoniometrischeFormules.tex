...
\pagestyle{fancy}
\fancyhead[RO,LE]{Goniometrische formules}
\fancyhead[RE,LO]{}
...
% TODO: bewijs toevoegen, zie mooi bewijs op
% http://www.hhofstede.nl/modules/sinaplusb.htm
...
\begin{oefening}{\em Bron: Pearson Edexcel, Pure Mathematics, may 2018}
  \begin{enumerate}[(a)]
  \item Toon aan dat de vergelijking
    $$4 \cos \theta - 1 = 2 \sin \theta \tan \theta$$
    herschreven kan worden als
    $$6 \cos^2 \theta - \cos \theta - 2 = 0$$
  \item Los nu algebraïsch op, voor $0\degree \leq x < 90\degree$
