...
\begin{multicols}{2}
  ...
  \begin{align*}
    ...
    d(c\cdot f) &= c\cdot f\\
    d(\dfrac{f}{g}) &=\dfrac{df\cdot g - f\cdot dg}{g^2}
  \end{align*}
  \begin{align*}
    de^x &= e^xdx\\
    da^x &= a^x\ln(a) dx\\
...
\begin{align*}
  \Delta y &\approx df(4)\\
\LRA\qquad  \log_2(5) - 2 &\approx \dfrac{1}{4\ln 2} \cdot 1\\        
\LRA\qquad  \log_2(5) &\approx 2 + \dfrac{1}{4\ln 2} \cdot 1\\        
\LRA\qquad  \log_2(5) &\approx 2 + \dfrac{1}{4\cdot 0.7}\\        
\LRA\qquad  \log_2(5) &\approx 2.36\\        
\end{align*}
