...
\pagestyle{fancy}
\lhead{}
\rhead{Oefeningen Combinatieleer}
...
\begin{multicols}{3}
\begin{enumerate}[(a)]
  \item $V^3_5=$\arulefill
  \item $V^2_7=$\arulefill
  \item $V^4_4=$\arulefill
\end{enumerate}
\end{multicols}
...
\begin{theorie}
\pagebreak
\subsection{Oefeningen}  % mathcentre
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(1.45,1.41) rectangle (10.52,6.62);
\fill[line width=0.4pt,fill=black,fill opacity=0.29] (0,1) -- (5.5,1) -- (5.5,5.5) -- (0,5.5) -- cycle;
